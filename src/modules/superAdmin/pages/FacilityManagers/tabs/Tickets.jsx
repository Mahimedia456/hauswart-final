  ...
  const tickets = [
    {
      ...
      date: "2024-07-23",
      description:
        "Main circuit breaker in the basement server room is tripping repeatedly. Possible overload or short circuit. Needs immediate investigation.",
    },
    {
      id: "#TKT-83471",
      category: "Plumbing",
      ...
      statusTone: "slate",
      date: "2024-07-22",
      description: "Routine plumbing check required due to slow drainage in restroom areas.",
    },
    {
      id: "#TKT-83470",
      ...
      statusTone: "green",
      date: "2024-07-21",
      description: "Preventive maintenance completed for ventilation equipment.",
    },
    {
      id: "#TKT-83469",
      ...
      statusTone: "dark",
      date: "2024-07-20",
      description: "General issue closed after investigation.",
    },
  ];
