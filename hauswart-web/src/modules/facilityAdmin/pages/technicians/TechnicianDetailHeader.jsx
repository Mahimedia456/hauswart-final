  ...
  return (
    <>
      <div className="bg-white/80 rounded-2xl border border-slate-200 p-6 shadow-md flex justify-between items-start">
        ...
        <div>
          <button
            onClick={() => navigate("/facility-manager/technicians")}
        ...
        <div className="flex gap-2">
          ...
          {/* EDIT */}
          <button
            onClick={() => navigate(`/facility-manager/technicians/${id}/edit`)}
          ...
          {/* DELETE */}
          <button
            onClick={() => navigate(`/facility-manager/technicians/${id}/delete`)}
