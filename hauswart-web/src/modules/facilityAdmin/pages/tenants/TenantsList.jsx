    ...
    <div className="space-y-6">
      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          <button
            onClick={() => navigate("/facility-manager/tenants/create")}
            ...
            {tenants.map(tn => (
              <tr key={tn.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  <IconButton icon="visibility" onClick={() => navigate(`/facility-manager/tenants/${tn.id}`)} />
                  <IconButton icon="edit" onClick={() => navigate(`/facility-manager/tenants/${tn.id}/edit`)} />
