  ...
  return (
    <div className="space-y-6">
      ...
      <Section title={dict.tenant_personalInformation}>
        ...
        <Actions>
          <Primary onClick={() => navigate(`/facility-manager/tenants/${id}/edit`)}>
      ...
      <Section title={dict.tenancyDetails}>
        ...
        <Actions>
          <Secondary onClick={() => navigate(`/facility-manager/tenants/${id}/documents`)}>
      ...
      <Section title={dict.propertyAssignment}>
        <InfoGrid>
          <Info
            ...
            link
            onClick={() => navigate(`/facility-manager/properties/1`)}
          />
