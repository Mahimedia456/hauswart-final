    ...
    <div className="space-y-6">
      ...
      <header className="flex justify-between items-center">
        ...
        <div className="flex gap-3">
          ...
          <button
            onClick={() => navigate("/super-admin/technicians/create")}
            ...
            {technicians.map(tc => (
              <tr key={tc.id} className="hover:bg-slate-50">
                ...
                <td className="px-6 py-4 text-right space-x-2">
                  <IconButton icon="visibility" onClick={() => navigate(`/super-admin/technicians/${tc.id}`)} />
                  <IconButton icon="edit" onClick={() => navigate(`/super-admin/technicians/${tc.id}/edit`)} />
