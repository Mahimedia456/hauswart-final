...
export default function MaintenanceTaskEditModal({ open, onClose, task }) {
    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div className="w-full max-w-3xl bg-white rounded-xl shadow-2xl flex flex-col">
        ...
        <header className="relative border-b border-zinc-200 px-6 py-5">
          <h1 className="text-xl font-bold">{dict.mt_edit_title}</h1>
          <p className="text-sm text-zinc-500">{dict.mt_edit_subtitle}</p>
