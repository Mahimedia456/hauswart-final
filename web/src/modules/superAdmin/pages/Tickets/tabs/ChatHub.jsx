    ...
    <div className="flex gap-6">
      ...
      <div className="w-1/4 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-xl p-4 border border-gray-200">
          <h3 className="text-lg font-bold mb-3">{dict.participants}</h3>
            ...
            {[
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-xs px-2 py-0.5 rounded-full bg-gray-200 w-fit">
                    {p.role}
                  </span>
                </div>
              </div>
      ...
      <div className="w-1/2 flex flex-col bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div className="p-4 border-t border-gray-200 bg-white">
          <div className="flex items-center bg-gray-100 rounded-xl p-2">
            ...
            {/* ONLY Attachment icon & Send button (as requested) */}
            ...
            <button
              onClick={sendMessage}
              className="p-2 bg-primary text-white rounded-lg hover:bg-black"
            >
